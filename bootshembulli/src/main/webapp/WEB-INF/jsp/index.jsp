...
<meta http-equiv="Expires" content="Sat, 01 dec 2001 00:00:00 GM7">
...
<body>
	<div role="navigation">
		<div class="navbar navbar-inverse">
			<a href="/" class="navbar-brand">ArtofSoul</a>
		...
		<c:when test="${mode == 'MODE_HOME'}">
			<div class="container" id="homeDiv">
				<div class="jumbotron text-center">
					...
					<h4>Have Fun <span class="glyphicon glyphicon-folder-open"></span></h4>
				</div>
			</div>
		</c:when>
